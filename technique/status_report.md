...
| LTX-2.3 | Fixed-step cache, feature-norm pruning, PISA sparse attention, LTX fusion stack, NVFP4-requested path | Passed | `outputs/technique_audit_ltx23/fullopt/out.mp4`, `perf.json` |
...
| Sparse attention | SpargeAttention | `technique/sparse_attention/spargeattention`, external adapter | Backend available |
...
| Quantization | NVFP4 | `technique/quantization/nvfp4`, ModelOpt/TE path | Runtime path available |
...
- `spas_sage_attn` is present in the shared environment.
